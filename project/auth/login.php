...
<body>
    <div class="login-container">
        <div class="login-header">
            <div class="login-icon">
                <img src="../img/logo.jpg" alt="Logo Barbearia" style="width: 100%; height: 100%; object-fit: cover; border-radius: 50%;">
            </div>
    ...
    <script>
        // Simulação de autenticação para o ambiente de preview
